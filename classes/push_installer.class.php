...
class push_installer  extends ecjia_installer {
    ...
    public function install() {
        ...
        if (!ecjia::config('push_order_placed_apps', ecjia::CONFIG_CHECK)) {
        	ecjia_config::instance()->insert_config('hidden', 'push_order_placed_apps', '', array('type' => 'hidden'));
        }
    ...
    public function uninstall() {
        ...
        if (ecjia::config('push_order_placed_apps', ecjia::CONFIG_CHECK)) {
        	ecjia_config::instance()->delete_config('push_order_placed_apps');
        }
